...
| [lifecycle](./charts/lifecycle) | `0.9.13` | `0.2.1` | A Helm umbrella chart for full Lifecycle stack |
...
| [lifecycle-ui](./charts/lifecycle-ui) | `0.3.6` | `0.2.1` | A Helm chart for Lifecycle UI (Next.js) |
