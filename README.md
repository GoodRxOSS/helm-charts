...
| [lifecycle](./charts/lifecycle) | `0.9.11` | `0.2.0` | A Helm umbrella chart for full Lifecycle stack |
...
| [lifecycle-ui](./charts/lifecycle-ui) | `0.3.4` | `0.2.0` | A Helm chart for Lifecycle UI (Next.js) |
